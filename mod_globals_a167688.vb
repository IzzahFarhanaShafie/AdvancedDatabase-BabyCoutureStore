Module mod_globals_a167688
    Public username As String

    Public myconnection As String = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=DB_BABYCOUTURESTORE_A167688.accdb;Persist Security Info=False;"
